...
| 字节1 | 字节2 | 字节3 | 字节4 -字节5 | 字节6-字节9 | 字节10 | 字节11 | 字节12 |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4 -字节5 | 字节6 - 字节9 | 字节10 | 字节11 | 字节12 -字节13 | 字节14 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4-字节5 | 字节6-字节7 | 字节8-字节9 | 字节10-字节13 |字节14 | 字节15 | 字节16|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4-字节5 | 字节6-字节7 | 字节8-字节9 | 字节10-字节13 | 字节14 | 字节15 | 字节16-字节17 | 字节18 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4-字节5 | 字节6 | 字节7-字节10 | 字节11 | 字节12 | 字节13 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4 | 字节5-字节6 | 字节7-字节10 | 字节11-字节12 | 字节13-字节14 | 字节15-字节16 | 字节17 | 字节18 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3 | 字节4 | 字节5 | 字节6 | 字节7-字节8 | 字节9-字节10 | 字节11-字节12 | 字节13-字节14 | 字节15-字节16 | 字节17-字节18 | 字节19 | 字节20 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 地址 | 功能码 | 辅助码 | 是否存储 | 回零模式 | 回零方向 | 回零速度 | 回零超时时间(Hi) | 回零超时时间(Lo) | 碰撞回零检测转速 | 碰撞回零检测电流 | 碰撞回零检测时间 | O_POT_En | 校验码 |
| Addr | 4C | AE | 00/01 | 00-05 | 00/01 | 0000-0BB8 | 0000-FFFF |0000-FFFF | 0000-0BB8 | 0000-1388 | 0000-FFFF | 00/01 | 6B |
...
| 字节1 | 字节2 | 字节3-字节4 | 字节5-字节6 | 字节7 |
| --- | --- | --- | --- | --- | --- |
| 地址 | 功能码 | 固件版本(bit15-0) | 硬件版本(bit 15-12:HW_Series，bit 11-8:HW_Type，bit 7-0:HW_Ver) | 校验码 |
...
| 字节1 | 字节2 | 字节3 | 字节4 |
| --- | --- | --- | --- |
| 地址 | 功能码 | 电机状态标志(bit7-bit0：Oac_TF 保留 Esi_RF Esi_LF Cgp_TF Cgi_TF Prf_TF Ens_TF) | 校验码 |
| Addr | 3A | 见参数说明 | 6B |
...
| 字节1 | 字节2 | 字节3 | 字节4 |
| --- | --- | --- | --- |
| 地址 | 功能码 | IO电平状态(bit7-bit0：保留 保留 Dir_OM Dir_Pin 0 Stp_Pin 0 En_Pin) | 校验码 |
| Addr | 3D | 见参数说明 | 6B |
...
| 字节1 | 字节2 | 字节3-字节6 | 字节7-字节10 | 字节11-字节14 | 字节15-字节19 | 字节20 |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
**主机发送（主机→电机）**
| 字节1 | 字节2 | 字节3| 字节4 | 字节5-字节8 | 字节9-字节12 | 字节13-字节16 | 字节17-字节20 | 字节21 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 字节1 | 字节2 | 字节3-字节6 | 字节7-字节10 | 字节11-字节14 | 字节15 |
| --- | --- | --- | --- | --- | --- | --- |
...
**主机发送（主机→电机）**
| 字节1 | 字节2 | 字节3 |字节4 | 字节5-字节8 | 字节9-字节12 | 字节13-字节16 | 字节17 |
| --- | --- | --- | --- | --- | --- | --- | --- |
